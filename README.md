...
+ If running with data from a specific date, uncomment RUNNING_WITH_DATE_STRING and DATE_STRING (intended to be the date of the last CSV file in the data directory). </br>
